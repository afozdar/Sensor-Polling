...
logging.basicConfig(filename='/var/log/merit_sensordata.log', level=logging.DEBUG, format=FORMAT, datefmt=DATE_FORMAT)
...
if(st.sensorinfo["generate"] == "both"):
    if __name__ == '__main__':
        p1 = Process(target = dl.loop_and_delay_write)
        p1.start()
        ani.graph_data()
